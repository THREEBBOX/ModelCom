...
for i in range(1,6):
    for j in range(1,6):
        ...
        aiclist.append(md.aic)
        biclist.append(md.bic)
print("===========MMMMM============")
print(aiclist)
aiclist=np.array(aiclist)
print(np.argsort(aiclist))
print(biclist)
biclist=np.array(biclist)
print(np.argsort(biclist))
totallsit= aiclist+biclist
print(np.argsort(totallsit)) # 选择方式为，bic和aic之和的最小值
